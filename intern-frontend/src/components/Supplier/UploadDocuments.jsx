            ...
            <div className="">
              <form
                ...
                onSubmit={async(e) => {
                  ...
                  await axios({
                    method: "post",
                    url: "http://localhost:5000/supplier/fileUpload",
                    data: {
                      file: data.get('file'),
                      _id: data.get('id')
                    },
              ...
              {/* <a target="_blank" href={`http://localhost:5000/supplier/downloadFiles/${window.localStorage.getItem("supID")}`}>Download Last Upload</a> */}
            </div>
          </div>
        </div>
      </div>
