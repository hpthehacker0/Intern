...
function CompanyLandingPage() {
  ...
  useEffect(() => {
    axios.get("http://localhost:5000/company/getSuppliers").then((res) => {
      console.log(res);
      setData(res.data);
    });
  }, []);
      ...
      <div className="w-[95%] bg-[#FCBD16] rounded-xl p-10 mt-5">
        <form
          ...
          onSubmit={(e) => {
            ...
            axios
              .put("http://localhost:5000/company/sendRequest", {
        ...
        >
          ...
          <div className="flex flex-col items-end justify-between h-[200px] basis-1/4">
            ...
            <a
              className="w-[100px] bg-white/20 p-2 rounded-2xl"
              target="_blank"
              href={`http://localhost:5000/company/downloadFiles/${value["_id"]}`}
            >
              Download
            </a>
            <button
