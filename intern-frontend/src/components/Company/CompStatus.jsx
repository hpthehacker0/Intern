...
function CompStatus() {
  ...
  useEffect(() => {
    axios
      .get(
        "http://localhost:5000/company/getAcceptedStatus/" +
        ...
        <form className="flex items-center justify-between h-[150px]">
          ...
          <div className="flex flex-col items-center justify-between h-[70%]">
            <a
              ...
              target="_blank"
              href={`http://localhost:5000/company/downloadCompanyFile/${localStorage.getItem(
                "compID"
              )}`}
            >
              Download
            ...
            <button
              ...
              onClick={(e) => {
                ...
                axios
                  .put(
                    "http://localhost:5000/company/contractComplete",
                    {
                      _id: value["_id"],
