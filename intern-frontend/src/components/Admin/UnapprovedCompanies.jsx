...
function UnapprovedCompanies() {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get("http://localhost:5000/admin/getUnapprovedCompData")
      .then((res) => {
        console.log(res);
  ...
  const approve = (id) => {
    ...
    axios
      .put("http://localhost:5000/admin/allowCompanies", {
        _id: id,
  ...
  const reject = (id, comments) => {
    ...
    axios
      .put("http://localhost:5000/admin/denyCompanies", {
        _id: id,
        comments: comments,
        username: window.sessionStorage.getItem("adminName"),
      })
              ...
              <div className="">
                {company.filename !== "" ? (
                  <a
                    ...
                    target="_blank"
                    href={`http://localhost:5000/admin/downloadCompanyFiles/${company._id}`}
                  >
                    Download
                  </a>
                ) : (
